...
#'@usage information.borrowing_lgim_normal(beta_initial,
#'gamma_initial,sigma2_initial,theta_ext_ini,theta_ext_est,
...
#'@usage asymptotic_var_general_normal(beta_est,gamma_est,
#'sigma2_est,theta_est,v_ext,y_int,x_int,used_index)
...
#'@description This function can integrate summary information from external source
#'@usage information.borrowing_gim_normal(beta_initial,
